...
const Community = () => {
  ...
  const fetchProjects = async () => {
    try {
      ...
      setProjects(data.projects || data.project || []);
    } catch (error: any) {
      console.log(error);
      ...
      <div className='px-4 md:px-16 lg:px-24 xl:px-32'>
        {loading ? (
                ...
                className='w-72 max-sm:mx-auto cursor-pointer bg-gray-900/60 border border-gray-700 rounded-lg overflow-hidden group hover:border-indigo-800/80 transition-all duration-300'>
                  ...
                  <div className='p-4 text-white bg-linear-180 from-transparent group-hover:from-indigo-950 to-transparent transition-colors'>
                    <div className='flex items-start justify-between'>
                      ...
                      <span className='px-2.5 py-0.5 mt-1 ml-2 text-xs bg-gray-800 border border-gray-700 rounded-full text-nowrap'>Website</span>
                    </div>
          ...
          <div className='flex flex-col items-center justify-center h-[80vh]'>
            <h1 className='text-3xl font-semitbold text-gray-300'>No published projects found!</h1>
