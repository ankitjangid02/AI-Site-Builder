...
const steps = [
    ...
    {icon: SquareIcon, label: "Generating layout struvture..."},
...
const LoaderSteps = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center bg-gray-950 relative overflow-hidden text-white">
      ...
      <p className="text-xs text-gray-400 mt-2 transition-opacity duration-700 opacity-100">This may take around 4-5 minutes...</p>
    </div>
  )
}
